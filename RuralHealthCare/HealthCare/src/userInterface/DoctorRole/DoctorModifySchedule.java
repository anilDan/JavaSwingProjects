...
public class DoctorModifySchedule extends javax.swing.JPanel {
    ...
    private void populateSchedule()
    {
        ...
        txtTime.setSelectedItem(schedule.getTime());
    ...
    private void btnSaveScheduleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveScheduleActionPerformed
        ...
        if(localDate.compareTo(date) ==-1)
            JOptionPane.showMessageDialog(null, "Please select Future Date!","INFORMATION",JOptionPane.INFORMATION_MESSAGE);
        else if(!txtHours.getText().matches("[1-9]"))
            JOptionPane.showMessageDialog(null, "Please Enter Hours between 1-9.","WARNING",JOptionPane.WARNING_MESSAGE);
        else if(!txtLocation.getText().matches("[A-Za-z]*"))
            JOptionPane.showMessageDialog(null, "Please Enter valid Location.","WARNING",JOptionPane.WARNING_MESSAGE);
